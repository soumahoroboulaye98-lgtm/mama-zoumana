...
async function notifierDestinataires(evt, avertissement) {
  const { date_evenement, heure_evenement, lieu, titre_fr, titre_en, titre_ar, description_fr, description_en, description_ar } = evt;
...
// ==================================================
// 📋 LISTER LES ÉVÉNEMENTS — ➤ AFFICHAGE INDEX
// ==================================================
